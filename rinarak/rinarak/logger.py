'''
 # @ Author: Zongjing Li
 # @ Create Time: 2023-01-05 09:39:40
 # @ Modified by: Zongjing Li
 # @ Modified time: 2023-01-10 13:06:56
...
class KFTLogFormatter(logging.Formatter):
    log_fout = None
...
def get_logger(name=None, formatter=KFTLogFormatter):
...
logger = get_logger('KFT')
"""The default logger of Karanir."""